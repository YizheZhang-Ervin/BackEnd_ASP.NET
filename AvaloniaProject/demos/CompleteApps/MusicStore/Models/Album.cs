...
namespace Avalonia.MusicStore.Models
{
    public class Album
    {
        ...
        /// <summary>
        /// 添加实现从磁盘加载的代码 Loads an album from the given stream.
        /// </summary>
        ...
        /// <summary>
        /// 专辑服务 Loads the album cover bitmap from cache or api.
        /// </summary>
        ...
        /// <summary>
        /// 添加实现保存到磁盘的代码 Calls SaveToStreamAsync to save album data to the local cache and creates cache folder if it didn't exist.
        /// </summary>
